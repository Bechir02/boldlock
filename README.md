...
[Live Demo](https://bechir02.github.io/boldlock/) • [Key Features](#-key-features) • [Free Deployment](#-100-free-live-deployment) • [Quickstart](#-quickstart) • [Architecture](#-architecture) • [Core API](#-core-engine-api) • [Contributing](#-contributing)
